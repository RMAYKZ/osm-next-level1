        ...
        {result && (
          <motion.div key="result" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: EASE }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div style={{ position: "relative", width: 72, height: 72, flexShrink: 0 }}>
                  ...
                  <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontSize: 18, fontWeight: 900, color: scoreColor, lineHeight: 1, fontFamily: "'Outfit', sans-serif" }}>{result.score}</span>
                          ...
                          {[
                            ...
                            <div key={row.label}>
                              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                                ...
                                <span style={{ fontSize: 14, fontWeight: 900, color: row.color, fontFamily: "'Outfit', sans-serif" }}>{row.val}</span>
                              </div>
            ...
            >
              ...
              <div style={{ fontSize: 16, fontWeight: 900, color: "#e2e8f0", fontFamily: "'Outfit', sans-serif", letterSpacing: "0.04em", marginBottom: 12 }}>
                {result.optFm}
              </div>
              {isPremium ? (
                  ...
                  {RESULT_SLIDERS.map((row, i) => (
                    <div key={row.label}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                        ...
                        <span style={{ fontSize: 15, fontWeight: 900, color: row.color, fontFamily: "'Outfit', sans-serif" }}>{row.val}</span>
                      </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {RESULT_SLIDERS.map(row => (
                    <div key={row.label}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                        <span style={{ fontSize: 10, fontWeight: 700, color: "rgba(148,163,184,0.5)", textTransform: "uppercase" }}>{row.label}</span>
                        <span style={{ fontSize: 15, fontWeight: 900, color: "rgba(148,163,184,0.2)", fontFamily: "'Outfit', sans-serif", filter: "blur(4px)" }}>??</span>
                      </div>
                      <div style={{ height: 4, borderRadius: 99, background: "rgba(255,255,255,0.05)", overflow: "hidden" }}>
