  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 5 }}>
        ...
        <span style={{ fontSize: 24, fontWeight: 900, lineHeight: 1, color, letterSpacing: "-0.03em", fontFamily: "'Outfit', sans-serif" }}>
          {value}
        </span>
      </div>
      ...
      <div style={{ padding: "22px 22px 20px" }}>
        <div style={{ display: "flex", gap: 14, alignItems: "flex-start", marginBottom: 16 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <h3 style={{ margin: "0 0 3px", fontSize: "clamp(1.05rem,2.5vw,1.35rem)", fontFamily: "'Outfit', sans-serif", fontWeight: 900, letterSpacing: "0.01em", color: "#f0f6ff", lineHeight: 1.1 }}>
              {tactic.name}
            </h3>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 18 }}>
          <div style={{ display: "inline-flex", alignItems: "center", background: "rgba(0,0,0,0.38)", border: `1px solid ${loc.border}`, borderRadius: 8, padding: "5px 12px" }}>
            <span style={{ fontSize: 13, fontWeight: 900, color: loc.primary, letterSpacing: "0.06em", fontFamily: "'Outfit', sans-serif" }}>{tactic.formation}</span>
          </div>
      ...
      <div style={{ padding: "22px 20px 20px" }}>
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center", marginBottom: 14 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: "clamp(1rem,2vw,1.2rem)", fontWeight: 900, color: "#f0f6ff", fontFamily: "'Outfit', sans-serif", letterSpacing: "0.02em", lineHeight: 1.1 }}>
              {tactic.formation}
            </div>
            ...
            {[
              ...
              <div key={s.label} style={{ marginBottom: 10 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
                  ...
                  <span style={{ fontSize: 22, fontWeight: 900, color: s.color, fontFamily: "'Outfit', sans-serif" }}>??</span>
                </div>
                <div style={{ height: 4, borderRadius: 99, background: "rgba(255,255,255,0.05)", overflow: "hidden" }}>
                      ...
                      >
                        {[
                          ...
                          >
                            ...
                            <div style={{ fontSize: 22, fontWeight: 900, color: "#fbbf24", fontFamily: "'Outfit', sans-serif", letterSpacing: "-0.01em", lineHeight: 1 }}>{s.value}</div>
