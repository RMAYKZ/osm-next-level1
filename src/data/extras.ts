...
/**
 * "1 <Month> <Year>" stamp for the current UK calendar month — always in
 * English, matching the site's other always-English marketing badges
 * (e.g. "NEW"). Rolls forward automatically on the 1st, so no monthly
 * code edit is needed to keep freshness badges current.
 */
export function getCurrentMonthStamp(d = new Date()): string {
  const [y, m] = getUKDateParts(d);
  return `1 ${EN_MONTH_NAMES[m]} ${y}`;
}
...
const PLAY_STYLE_KEY: Record<string, string> = {
  ...
  "Paslı Oyun":       "ptv.passliOyun",
  "Kaleyi Görünce Vur (KGV)": "ptv.kgv",
};
...
export interface PremiumTactic {
  ...
  solid?: boolean;
  isNew?: boolean;
  battleTactic?: boolean; // renders ⚔️ BATTLE TACTIC badge
  featured?: boolean;     // full-width special card layout
  fireTactic?: boolean;   // full-width blazing flame card layout
  addedAt?: string; // "YYYY-MM-DD" — used to show hot colour for first 2 days
}

export const premiumTactics: PremiumTactic[] = [
  // ── AĞUSTOS 2026 — Özel Karşı Taktikleri (6 Ağustos güncellemesi) ──
  {
    id: "aug-home-433b-universal",
    location: "home",
    name: "4-3-3 B Kanatları Kullan — Evde Tek Diziliş Çözümü",
    scenario: "Evde · Her rakibe karşı tek diziliş",
    formation: "4-3-3 B",
    ...
    defenseShape: "Alan Markajı",
    offside: "Kapalı",
    effectiveVs: ["5-2-3", "4-5-1", "4-2-3-1", "5-3-2", "5-3-1-1"],
    note: "Evde her rakibe karşı tek bir diziliş oynamak istiyorsan bu senin taktiğin. Forvet tam hücumda, orta saha pozisyon koruyor, defans geride sağlam duruyor. Özellikle 5-2-3, 4-5-1, 4-2-3-1, 5-3-2 ve 5-3-1-1 oynayan rakiplere karşı gerçekten işe yarıyor.",
    solid: true,
    isNew: true,
    fireTactic: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-451-4231-kgv",
    location: "away",
    name: "4-5-1 / 4-2-3-1 KGV — 5-2-3 Kontraya Özel",
    scenario: "451 / 4-2-3-1 oynayanlara özel · 5-2-3 kontraya karşı",
    formation: "4-5-1",
    playStyle: "Kaleyi Görünce Vur (KGV)",
    pressure: 33,
    style: 21,
    tempo: 76,
    forward: "Sadece Hücum",
    ...
    offside: "Kapalı",
    effectiveVs: ["5-2-3"],
    note: "4-5-1 veya 4-2-3-1 oynayanlar için özel taktik, 523 kontra atağına karşı etkili. Kaleyi Görünce Vur stiliyle forvet sadece hücumda, orta saha pozisyonunu koruyor. Ev veya deplasmanda kullanılabilir — evde oynarken baskı 55, stil 35, tempo 55 değerlerine çekip mevkileri aynı bırakabilirsin.",
    isNew: true,
    battleTactic: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-home-523-strong",
    location: "home",
    name: "5-2-3'e Karşı 4-3-3 B Kanat — Güçlüyken",
    scenario: "Evde güçlüyken · 5-2-3 A/B'ye karşı",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 53,
    style: 73,
    ...
    offside: "Açık",
    effectiveVs: ["5-2-3"],
    note: "Evde güç durumu bizden yanaysa 5-2-3 A/B oynayan rakiplere karşı 4-3-3 B ile kanatlardan yükleniyoruz. Forvet tam hücumda, orta saha pozisyonunu koruyor, defans geride bekliyor. Yüksek stil ve tempo ile rakibi kanatlardan eziyoruz.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-home-523-even",
    location: "home",
    name: "5-2-3'e Karşı 4-3-3 B Kanat — Eşitken",
    scenario: "Evde eşitken · 5-2-3 A/B'ye karşı",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 52,
    style: 62,
    ...
    offside: "Açık",
    effectiveVs: ["5-2-3"],
    note: "Kadrolar eşit seviyedeyken aynı 4-3-3 B kanat taktiğini biraz düşük baskı ve tempoyla oynuyoruz, orta saha bu sefer defansa yardım ederek dengeyi koruyor.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-home-523-weak",
    location: "home",
    name: "5-2-3'e Karşı 4-3-3 B Kanat — Zayıfken",
    scenario: "Evde zayıfken · 5-2-3 A/B'ye karşı",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 50,
    style: 60,
    ...
    offside: "Açık",
    effectiveVs: ["5-2-3"],
    note: "Rakip bizden güçlüyken bile 5-2-3'e karşı bu taktik işe yarıyor — baskı ve tempoyu biraz daha kısarak orta sahayı defansa çekiyoruz, kanatlardan gelen ataklarla fark yaratıyoruz.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-home-433-strong",
    location: "home",
    name: "4-3-3'e Karşı 4-3-3 A Paslı Oyun — Güçlüyken",
    scenario: "Evde güçlüyken · 4-3-3 A/B'ye karşı",
    formation: "4-3-3 A",
    playStyle: "Paslı Oyun",
    pressure: 65,
    style: 65,
    tempo: 70,
    forward: "Sadece Hücum",
    ...
    offside: "Kapalı",
    effectiveVs: ["4-3-3"],
    note: "Evde güçlüyken 4-3-3 A'nın paslı oyun stiliyle 4-3-3 oynayan rakiplere karşı topu elde tutuyoruz. Orta saha pozisyonunu koruyor, forvet sürekli hücumda.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-home-433-even",
    location: "home",
    name: "4-3-3'e Karşı 4-3-3 B Kanat — Eşitken",
    scenario: "Evde eşitken · 4-3-3 A/B'ye karşı",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 61,
    style: 60,
    ...
    offside: "Kapalı",
    effectiveVs: ["4-3-3"],
    note: "Kadrolar eşitken 4-3-3 B kanat taktiğine geçiyoruz, orta saha defansa yardım ederek denge kuruyor. 4-3-3 oynayan rakiplere karşı etkili.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-home-433-weak",
    location: "home",
    name: "4-3-3'e Karşı 4-3-3 A/B Kanat — Zayıfken",
    scenario: "Evde zayıfken · 4-3-3 A/B'ye karşı",
    formation: "4-3-3 A/B",
    playStyle: "Kanatları Kullan",
    pressure: 56,
    style: 62,
    ...
    offside: "Kapalı",
    effectiveVs: ["4-3-3"],
    note: "Zayıf durumdayken bile 4-3-3 A/B kanat taktiği ile ayakta kalabiliyoruz — baskı ve tempo düşürülüyor, orta saha defansif görev üstleniyor.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-away-523-strong",
    location: "away",
    name: "5-2-3'e Karşı 4-3-3 B Kanat — Deplasman Güçlü",
    scenario: "Deplasmanda güçlüyken · 5-2-3 A/B'ye karşı",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 58,
    style: 73,
    ...
    offside: "Kapalı",
    effectiveVs: ["5-2-3"],
    note: "Deplasmanda güçlüyken 5-2-3 oynayan rakiplere karşı 4-3-3 B kanat taktiğiyle çıkıyoruz. Orta saha pozisyonunu koruyor, kanatlardan gelen ataklarla fark yaratıyoruz.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-away-523-even",
    location: "away",
    name: "5-2-3'e Karşı 5-2-3 B Kontra — Deplasman Eşit",
    scenario: "Deplasmanda eşitken · 5-2-3 A/B'ye karşı",
    formation: "5-2-3 B",
    ...
    offside: "Kapalı",
    effectiveVs: ["5-2-3"],
    note: "Deplasmanda eşit durumdayken 5-2-3 B kontra atak taktiğine geçiyoruz — düşük baskı, düşük stil, orta seviye tempo ile rakibi bekleyip kontrayla vuruyoruz.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-away-523-weak",
    location: "away",
    name: "5-2-3'e Karşı 5-2-3 B Kontra — Deplasman Zayıf",
    scenario: "Deplasmanda zayıfken · 5-2-3 A/B'ye karşı",
    formation: "5-2-3 B",
    playStyle: "Kontra Atak",
    pressure: 21,
    style: 12,
    ...
    offside: "Kapalı",
    effectiveVs: ["5-2-3"],
    note: "Deplasmanda zayıf durumdayken bile 5-2-3 B kontra atak işe yarıyor — baskı ve stili minimuma indirip sadece kontraya odaklanıyoruz.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-away-433-strong",
    location: "away",
    name: "4-3-3'e Karşı 4-3-3 B Kanat — Deplasman Güçlü",
    scenario: "Deplasmanda güçlüyken · 4-3-3 A/B'ye karşı",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 66,
    style: 60,
    ...
    offside: "Kapalı",
    effectiveVs: ["4-3-3"],
    note: "Deplasmanda güçlüyken 4-3-3 oynayan rakiplere karşı 4-3-3 B kanat taktiğiyle yükleniyoruz, orta saha pozisyonunu koruyor.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-away-433-even",
    location: "away",
    name: "4-3-3'e Karşı 4-3-3 B Kanat — Deplasman Eşit",
    scenario: "Deplasmanda eşitken · 4-3-3 A/B'ye karşı",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 48,
    style: 62,
    ...
    offside: "Kapalı",
    effectiveVs: ["4-3-3"],
    note: "Deplasmanda eşit durumdayken aynı 4-3-3 B kanat taktiğini biraz daha düşük baskıyla oynuyoruz, orta saha defansa yardım ediyor.",
    isNew: true,
    addedAt: "2026-08-06",
  },
  {
    id: "aug-away-433-weak",
    location: "away",
    name: "4-3-3'e Karşı 5-4-1 B KGV — Deplasman Zayıf",
    scenario: "Deplasmanda zayıfken · 4-3-3 A/B'ye karşı",
    formation: "5-4-1 B",
    playStyle: "Kaleyi Görünce Vur (KGV)",
    pressure: 26,
    style: 14,
    ...
    offside: "Kapalı",
    effectiveVs: ["4-3-3"],
    note: "Deplasmanda zayıfken 4-3-3 oynayan rakiplere karşı 5-4-1 B Kaleyi Görünce Vur taktiğine geçiyoruz — çok düşük baskı ve stil, yüksek tempoyla hızlı şutlarla fark arıyoruz.",
    isNew: true,
    addedAt: "2026-08-06",
  },

  // ── TEMMUZ 2026 — Arşiv Taktikler ──
  {
    id: "july-home-433b-fire",
    location: "home",
    name: "4-3-3 B Kanatları Kullan",
    scenario: "Evde · Her rakibe karşı · En Güncel Taktik",
    formation: "4-3-3 B",
    playStyle: "Kanatları Kullan",
    pressure: 75,
    style: 65,
    ...
    offside: "Kapalı",
    winRate: "90",
    note: "Şu an kullandığımız en güçlü ev taktiği. Evdeyken her rakibe karşı çalışıyor — diziliş fark etmez. Kanatlar tam gaz hücuma gidiyor, orta saha pozisyonunu koruyor, defans geride sağlam bekliyor. Şu anki en güncel ve en etkili ev silahımız.",
    solid: true,
    isNew: true,
    fireTactic: true,
    addedAt: "2026-07-01",
  ...
  {
    id: "july-away-523-battle",
    location: "away",
    name: "5-2-3 Kontra Atak — Battle Tactic",
    scenario: "Deplasman · 5-2-3, 4-5-1, 5-3-2, 4-2-3-1'e karşı",
    formation: "5-2-3",
    playStyle: "Kontra Atak",
    pressure: 33,
    style: 21,
    ...
    offside: "Kapalı",
    winRate: "88",
    effectiveVs: ["5-2-3", "4-5-1", "5-3-2", "4-2-3-1"],
    note: "Şu an Top 5'te aktif kullandığımız ve harika sonuç veren deplasman silahımız. Rakip çekilirse biz kontrayla vururuz — 5-2-3, 4-5-1, 5-3-2 ve 4-2-3-1 oynayan rakiplere karşı doğrudan kullan.",
    warning: "4-3-3 oynayan rakiplere karşı kullanma — bu dizilişe karşı etkisiz.",
    solid: true,
    isNew: true,
    battleTactic: true,
    addedAt: "2026-07-01",
  ...
  {
    id: "july-away-433ab-battle",
    location: "away",
    name: "4-3-3 A/B Kanatları Kullan — Battle Tactic",
    scenario: "Deplasman · Güçlüysek veya eşitsek · 4-3-3, 5-3-2, 5-2-3'e karşı",
    formation: "4-3-3 A",
    playStyle: "Kanatları Kullan",
    pressure: 60,
    style: 65,
    ...
    offside: "Kapalı",
    winRate: "87",
    effectiveVs: ["4-3-3", "5-3-2", "5-2-3"],
    note: "Deplasmanda güçlüysek veya eşit durumdaysak bu taktiği devreye alıyoruz. Kanatları kullanarak rakibi genişletiyor, orta saha savunma kalkanı oluşturuyor. 4-3-3, 5-3-2 ve 5-2-3 oynayan rakiplere karşı son derece etkili.",
    solid: true,
    isNew: true,
    battleTactic: true,
    featured: true,
  ...
  {
    id: "july-home-433a-v2",
    location: "home",
    name: "4-3-3 A · Kanatları Kullan",
    scenario: "Evde · Kanatlar + Orta saha kalkanı",
    formation: "4-3-3 A",
    playStyle: "Kanatları Kullan",
    pressure: 63,
    style: 72,
    ...
    offside: "Kapalı",
    winRate: "85",
    note: "4-3-3 A'nın defans yardımlı versiyonu. Kanatlardan sürekli baskı uygularken orta saha geride güvenli bir koridor oluşturur. Rakip kontra oynamıyorsa ideal tercih.",
    isNew: true,
    addedAt: "2026-07-01",
  },
  {
  ...
  },
  {
    ...
    offside: "Kapalı",
    winRate: "90",
    note: "Rakip ne oynarsa oynasın, bu taktik çalışıyor. Güvenilir, sağlam bir ev taktiği.",
    warning: "Güncelleme gelirse sayılar değişebilir. Takip et!",
  },
  {
    id: "july-home-433a",
